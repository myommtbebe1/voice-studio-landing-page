      ...
      <div ref={cardsGridRef} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        {loading ? (
          Array.from({ length: cardsPerPage }).map((_, index) => (
            <div key={`skeleton-${index}`} className="rounded-lg shadow-md border border-gray-200 p-1 flex gap-3 h-32">
              <div className="shrink-0 w-32 h-full rounded-lg bg-gray-200 animate-pulse" />
            ...
            >
              <div
                className={isPremiumCard
                  ? 'bg-white rounded-[5px] shadow-md p-1 hover:shadow-lg transition-shadow flex gap-3 h-32'
                  : 'bg-white rounded-lg shadow-md border border-gray-200 p-1 hover:shadow-lg transition-shadow flex gap-3 h-32'
                }
              >
